...
syms m1 m2 m3 dc1 dc2 dc3 r1 r2 r3 real % m1 is unnecessary
...
% links as full cylinders with uniform mass of radius r [m] 
r1=0.2;  
...
C=[dq'*C1;dq'*C2;dq'*C3];
S=dM-2*C
check_S_plus_Stransp=simplify(S+S')   % should be zero
